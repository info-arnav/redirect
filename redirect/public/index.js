function userAgent() {
  ...
  -1 != (i = r.indexOf("Opera"))
    ? ((s = "Opera"),
      (a = r.substring(i + 6)),
      -1 != (i = r.indexOf("Version")) && (a = r.substring(i + 8)))
    : -1 != (i = r.indexOf("MSIE"))
    ? ((s = "Microsoft Internet Explorer"), (a = r.substring(i + 5)))
    : -1 != (i = r.indexOf("Chrome"))
    ? ((s = "Chrome"), (a = r.substring(i + 7)))
    : -1 != (i = r.indexOf("Safari"))
    ? ((s = "Safari"),
      (a = r.substring(i + 7)),
      -1 != (i = r.indexOf("Version")) && (a = r.substring(i + 8)))
    : -1 != (i = r.indexOf("Firefox"))
    ? ((s = "Firefox"), (a = r.substring(i + 8)))
    : -1 != r.indexOf("Trident/")
    ? ((s = "Microsoft Internet Explorer"),
      (a = r.substring(r.indexOf("rv:") + 3)))
    : (e = r.lastIndexOf(" ") + 1) < (i = r.lastIndexOf("/")) &&
      ((s = r.substring(e, i)),
      (a = r.substring(i + 1)),
    ...
    isNaN(c) &&
      ((a = "" + parseFloat(navigator.appVersion)),
      (c = parseInt(navigator.appVersion, 10)));
  var d = /Mobile|mini|Fennec|Android|iP(ad|od|hone)|BlackBerry|BB10/.test(t),
    l = (navigator.cookieEnabled ? !0 : !1, o),
    h = [
  ...
  var g = o;
  switch (
    (/Windows/.test(l) && ((g = /Windows (.*)/.exec(l)[1]), (l = "Windows")), l)
  ) {
    case "Mac OS X":
      g = /Mac OS X (10[\.\_\d]+)/.exec(r)[1];
      break;
    case "Android":
      g = /Android ([\.\_\d]+)/.exec(r)[1];
      break;
    case "iOS":
      (g = /OS (\d+)_(\d+)_?(\d+)?/.exec(t)),
        (g = g[1] + "." + g[2] + "." + (0 | g[3]));
      break;
    case "BlackBerry":
      g = /BlackBerry\w+\/([\d\.]+)/i.exec(r)[1];
      break;
    case "BB10":
      g = 10;
  }
  return d
    ? "chrome" === s.toLowerCase()
      ? !1
      : "opera" === s.toLowerCase() && a >= 10
      ? !1
      : "firefox" === s.toLowerCase()
      ? !1
      : "android" === l.toLowerCase() && 4 >= g
      ? !1
      : "ios" === l.toLowerCase() && g >= 4
      ? !1
      : ("blackberry" === l.toLowerCase() || "bb10" === l.toLowerCase()) &&
        g >= 10
      ? !1
      : !0
    : "microsoft internet explorer" === s.toLowerCase()
    ? !0
    : "chrome" === s.toLowerCase()
    ? "windows" === l.toLowerCase() &&
      "xp" === g.toLowerCase() &&
      parseFloat(a) <= 6
      ? !0
      : l.toLowerCase().indexOf("mac os") > -1 &&
        parseFloat(g) < 10.5 &&
        parseFloat(a) <= 5
      ? !0
      : !1
    ...
    ? parseFloat(a) <= 2
      ? !0
      : !1
    : "safari" === s.toLowerCase()
    ? parseFloat(a) <= 3
      ? !0
      : "windows" === l.toLowerCase() && "xp" === g.toLowerCase()
      ? !0
      : l.toLowerCase().indexOf("mac os") > -1 && parseFloat(g) <= 10.5
      ? !0
      : !1
    : void 0;
}
function setDomainName() {
  userAgent()
    ? ((staticResourceURL = "//c4c.phonon.in/Click2CallGWT/"),
      (nonStaticResourceURL = "//c4c.phonon.in/Click2CallGWT/"))
    : ((staticResourceURL = "//aws.phonon.in/Click2CallGWT/"),
      (nonStaticResourceURL = "//c4c.phonon.in/Click2CallGWT/"));
}
function getStaticResourceURL() {
  return setDomainName(), staticResourceURL;
}
function callme(e, i, n, o, t, r) {
  if (
    (-1 !== e.indexOf("{") && (e = getReferrerI(e)),
    -1 !== i.indexOf("{") && (i = getReferrerI(i)),
    -1 !== n.indexOf("{") && (n = getReferrerI(n)),
    -1 !== o.indexOf("{") && (o = getReferrerI(o)),
    -1 !== t.indexOf("{") && (t = getReferrerI(t)),
    -1 !== r.indexOf("{") && (r = getReferrerI(r)),
    /Mobile|mini|Fennec|Android|iP(ad|od|hone)|B(lackBerry|B10)|RIM/.test(
      navigator.userAgent
    ) && "8tukl1ao" === e)
  )
    window.location =
      nonStaticResourceURL.substring(
        0,
        nonStaticResourceURL.indexOf("Click2CallGWT")
      ) +
      "MobileWidget/index.jsp?custToken=" +
      e +
      "&udf1=" +
      i +
      "&udf2=" +
    ...
    console.log("custtoken in else :" + e),
      "rj4t7q85" === e
        ? "banner" === o
          ? ((height = "60"), (width = "905"))
          : "DialB2B" === o
          ? ((height = "334"), (width = "306"))
          : ((height = "294"), (width = "306"))
        : "ax890ad" === e
        ? "banner" === o
          ? ((height = "60"), (width = "905"))
          : "AMEXNEW" === o
        ...
        : "ct987df" === e
        ? "citibank" === o && ((height = "260"), (width = "400"))
        : "1nfrwstj" === e
        ? "banner" === o
          ? ((height = "60"), (width = "905"))
          : ((width = "284"), (height = "304"))
        : "8tukl1ao" === e
        ? ((closeBtnCSS = "cee_closeBtnITC"),
          "banner" === o
            ? ((height = "60"), (width = "905"))
            : ((width = "404"), (height = "389")))
        : "jfw98uj" === e
        ? (console.log("custtoken:" + e),
          (closeBtnCSS = "cee_closeBtnBIJLIPAY"),
          "banner" === o
            ? ((height = "60"), (width = "905"))
        ...
        ? ((height = "60"), (width = "905"))
        : ((width = "284"), (height = "304")),
      console.log("close btn=" + closeBtnCSS);
    var s = staticResourceURL + "CallMePage.jsp";
    (s =
      s +
      "?CustToken=" +
      e +
      ...
      "&UDF5=" +
      r +
      "&UDF6=1&sessionID=1234"),
      $("body").append(
        '<div id="cee_overlay" class="cee_close"></div>\n\n<div id="cee_html" class="cee_html divpopup" height="' +
          height +
          '" width="' +
          width +
          '" >\n\n<a title="Close" class="cee_close" id="' +
          closeBtnCSS +
          '" href="javascript:;">close</a>\n \n<div><h2></h2></div>\n\n<div id="cee_ajax">\n\n<iframe id="ceeboxiframe" class="ceeboxiframe" scrolling="no" height="' +
          height +
          '" width="' +
          width +
          '"src="' +
    ...
    a.css({ left: l, top: h }),
      $(
        "#cee_closeBtn,#cee_closeBtnITC,#cee_closeBtnBIJLIPAY,#cee_overlay"
      ).click(function () {
        $("#ceeboxiframe").remove(),
          $("#cee_overlay").hide(),
          $("#cee_overlay").remove(),
          $("#cee_html").remove(),
          "ax890ad" === e && _gaq.push(["_trackEvent", "Close", "Close"]);
      });
  }
}
function includeCSS() {
  ...
  (e.rel = "stylesheet"),
    (e.type = "text/css"),
    (e.href = staticResourceURL + "static/CSS/StaticPopup.css"),
    document.getElementsByTagName("head")[0].appendChild(e);
}
function includeJQuery() {
  if (!window.jQuery) {
    var e = document.createElement("script");
    (e.src = staticResourceURL + "static/JS/jquery-1.11.2.min.js"),
      (e.type = "text/javascript"),
      document.getElementsByTagName("head")[0].appendChild(e);
  }
}
function getReferrerI(e) {
  return (
    (e = e.toString()),
    (e = e.replace("{", "")),
    (e = e.replace("}", "")),
...
var height = "",
  width = "",
  closeBtnCSS = "cee_closeBtn";
getStaticResourceURL(), includeCSS(), includeJQuery();
var staticResourceURL, nonStaticResourceURL;
(function (a, b) {
  function cA(a) {
    return f.isWindow(a)
      ? a
...
function get_form(C) {
  for (var B = 0; B < document.forms.length; B++) {
    for (var A = 0; A < document.forms[B].length; A++) {
      if (document.forms[B].elements[A].name == C) {
        return document.forms[B].elements[A].form;
      }
    }
  }
}
...
function toggle_view(A) {
  if (document.getElementById) {
    ...
    if (document.layers && document.layers[A] != null) {
      if (
        document.layers[A].visibility == "visible" ||
...
function style_chkbx(C, A) {
  C.checked == true ? (B = A) : (B = "");
  do {
    C = C.parentNode;
  } while (C.nodeName != "TR");
  var B;
...
function style_form(B, A) {
  do {
    B = B.parentNode;
  } while (B.nodeName != "TR");
  B.style.backgroundColor = A;
}
function getselectedradio(A) {
  if (A[0]) {
...
function getselectedradiovalue(A) {
  var B = getselectedradio(A);
  if (B == -1) {
    return false;
  } else {
    if (A[B]) {
...
function bullet(A) {
  document.write(
    "<table cellspacing=0 cellpadding=0 border=0 style='font-size:8px'><tr bgcolor='" +
      A +
      "'><td>&nbsp;&nbsp;</td></tr></table>"
  );
}
function bullet1(A) {
  document.write(
    "<table cellspacing='0' cellpadding='0' align='left'><tr><td bgcolor='#000000'><table cellspacing=1 cellpadding=0 border=0 style='font-size:8px'><tr bgcolor='" +
      A +
      "'><td>&nbsp;&nbsp;</td></tr></table></td></tr></table>"
  );
}
function bullet2(B, A, C) {
  document.write(
    "<table cellspacing='0' cellpadding='0' align='left'><tr><td bgcolor='#000000'><table cellspacing=1 cellpadding=0 border=0 style='font-size:8px'><tr bgcolor='" +
      B +
      "'><td style='" +
...
function confirm_click(B, A) {
  if (confirm(B)) {
    window.location = A;
  }
}
function hide_advanced_search(A) {
  var B = A ? A : "";
  document.getElementById("advanced_search" + B).style.visibility = "hidden";
  document.getElementById("advanced_search" + B).style.display = "none";
  if (document.getElementById("category_search_box" + B)) {
    document.getElementById("category_search_box" + B).style.visibility =
      "hidden";
    document.getElementById("category_search_box" + B).style.display = "none";
  }
  document.getElementById("search" + B).innerHTML =
    '<a href="javascript:void(0);" onclick="javascript:show_advanced_search(\'' +
    B +
    "')\">Advanced Search</a>";
}
function show_advanced_search(A) {
  var B = A ? A : "";
  document.getElementById("search" + B).innerHTML =
    '<a href="javascript:void(0);" onclick="hide_advanced_search(\'' +
    B +
    "')\">Normal Search</a>";
  document.getElementById("advanced_search" + B).style.visibility = "visible";
  document.getElementById("advanced_search" + B).style.display = "inline";
  if (document.getElementById("category_search_box" + B)) {
    document.getElementById("category_search_box" + B).style.visibility =
      "visible";
    document.getElementById("category_search_box" + B).style.display = "inline";
  }
  return;
}
...
ga("create", "UA-153672641-50", "auto");
...
(function(a, b) {
    ...
    a.ui.plugin.add("resizable", "alsoResize", {
            ...
            var d = a(this).data("resizable")
              ...
              , i = function(b, e) {
                a(b).each(function() {
                    ...
                    a.browser.opera && /relative/.test(b.css("position")) && (d._revertToRelativePosition = !0,
                    b.css({
                        position: "absolute",
                        top: "auto",
                        left: "auto"
        ...
        stop: function(b, c) {
            ...
            d._revertToRelativePosition && (d._revertToRelativePosition = !1,
            typeof e.alsoResize == "object" && !e.alsoResize.nodeType ? a.each(e.alsoResize, function(a) {
                f(a)
            }) : f(e.alsoResize)),
...
(function(a, b) {
    ...
    a.widget("ui.button", {
        ...
        _create: function() {
            ...
            typeof this.options.disabled != "boolean" && (this.options.disabled = this.element.propAttr("disabled")),
